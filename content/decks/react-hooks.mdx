...
![class-example](/class-example.png)
...
<Notes>
  Do you see the bug? An eagle-eyed code reviewer may have noticed a potential
  bug in the initial class based version - we're not cleaning up the
  subscription when the component unmounts.
</Notes>

---

![hook-example](/hook-example.png)

---

<Split>

![hook-example](/hook-useHook.png)

![hook-example](/hook-useHook-example.png)
